...
MainWindow2::MainWindow2(QWidget *parent, Qt::WFlags flags)
...
void MainWindow2::fileOpen()
{
	...
	highlight->setHighlight( QsvLangDefFactory::getInstanse()->getHighlight( fileName ) );
